...
QString const versionText("0.12c");
QString const version("0.12c");
...
enum ErrorList { UPLOAD_FAIL, UPLOAD_METHOD_NOT_CHOOSED, CANT_SAVE_IMAGE_TEMP /*Can't save the image for upload */ };
