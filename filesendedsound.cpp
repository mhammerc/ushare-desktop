...
FileSendedSound::FileSendedSound(QObject * parent) :
    QObject(parent), fileSendedSoundOne(":/fileSended.wav"), fileSendedSoundTwo(":/Easter_Egg.wav"), easterEggActivated(false), sound(new QSound(fileSendedSoundOne, parent))
{}
